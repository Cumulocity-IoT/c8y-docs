wkhtmltopdf \
 ...
 --xsl-style-sheet ../../templates/cumulocity-toc-style.xsl \
   http://localhost:1313/docs/about_documentation/scope/ \
  http://localhost:1313/docs/about_documentation/documentation-repository/ \
"About this documentation-y2025.pdf"
