wkhtmltopdf \
 ...
 --xsl-style-sheet ../../templates/cumulocity-toc-style.xsl \
   http://localhost:1313/docs/additional-resources/more-documentation/ \
  http://localhost:1313/docs/additional-resources/more-resources/ \
  http://localhost:1313/docs/additional-resources/contacting-support/ \
"additional-resources-y2025.pdf"
