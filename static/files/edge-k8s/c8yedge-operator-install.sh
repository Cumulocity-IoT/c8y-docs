...
#
# Example:
#   Installing latest version (2025.0.2) into 'c8yedge' namespace:
...
display_usage() {
    ...
    echo ""
    echo "Example:"
    echo "  Installing latest version (2025.0.2) into 'c8yedge' namespace:"
...
if [ -z "$C8YEDGE_OPERATOR_VERSION" ]; then
    C8YEDGE_OPERATOR_VERSION="2025.0.2"
fi
