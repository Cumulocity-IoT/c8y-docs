...
For more detailed information, see [Receiving update notifications]({{<link-apama-webhelp>}}/standard-connectivity-plugins/the-cumulocity-iot-transport-connectivity-plug-in/#receiving-update-notifications) in the Apama documentation for the {{< product-c8y-iot >}} transport connectivity plug-in.
