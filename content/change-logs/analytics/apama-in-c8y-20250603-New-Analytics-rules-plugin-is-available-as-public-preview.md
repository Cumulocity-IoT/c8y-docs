...
For more details about the Smart rules plugin, refer to [Smart rules plugin](https://cumulocity.com/docs/streaming-analytics/smart-rules-plugin#what-is-the-smart-rules-plugin).
