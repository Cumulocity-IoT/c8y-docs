...
{{< c8y-admon-preview >}}
This feature is in Public Preview, that is, it is not enabled by default and may be subject to change in the future. The Smart rules 2.0 feature was previously named “Analytics rules”.
{{< /c8y-admon-preview >}}
