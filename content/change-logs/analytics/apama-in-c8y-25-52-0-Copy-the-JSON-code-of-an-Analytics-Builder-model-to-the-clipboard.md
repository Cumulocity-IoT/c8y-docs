...
In addition, the **Download** command, which also appears in this actions menu, is now also available to read-only users. See also [Copying a model](/streaming-analytics/analytics-builder/#copying-a-model) and [Downloading a model](/streaming-analytics/analytics-builder/#downloading-a-model).
