...
This functionality is now deprecated. The tenant options will no longer be attached as headers to the requests to the microservices, and the removal is planned for Q1 2026 in CD versions and in the 2027 annual release. The retrieval of the tenant options will remain possible through the endpoint `<TENANT_DOMAIN>/tenant/options/<microservice_name>`.
