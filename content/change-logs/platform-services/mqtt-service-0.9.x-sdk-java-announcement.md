...
This change only affects the new [MQTT Service](/device-integration/mqtt-service/) capability and does not affect the [Core MQTT](/device-integration/mqtt/) capability.
