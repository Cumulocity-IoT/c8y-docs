...
Introduced a new configuration option in the Java SDK that allows stripping control characters from JSON strings when deserializing responses from the API.
