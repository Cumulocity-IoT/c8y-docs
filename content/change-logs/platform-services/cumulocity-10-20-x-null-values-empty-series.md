...
version: 10.20.x.x
---
Missing measurements are indicated by a null placeholder in the `values` array of [series endpoint](https://cumulocity.com/api/core/#operation/getMeasurementSeriesResource)
