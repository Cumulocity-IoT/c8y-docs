...
date: 
title: >-
  Tenant administrators can now disable MQTT Service basic authentication
change_type:
...
Tenant administrators can now disable basic authentication for MQTT Service connections, requiring every device to use certificate authentication instead.
