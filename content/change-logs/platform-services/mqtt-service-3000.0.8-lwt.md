...
MQTT version 5.0 Will Message properties — _Delay Interval_, _Payload Format Indicator_, _Content Type_, _Response Topic_, _Correlation Data_, _Message Expiry Interval_ and _User Property_ — are forwarded to consumers via the standard Pulsar message properties.
