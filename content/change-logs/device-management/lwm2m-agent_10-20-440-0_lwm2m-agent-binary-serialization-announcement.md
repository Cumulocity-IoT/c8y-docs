...
This change affects the way how the data is represented in {{< product-c8y-iot >}} objects (operations, values displayed in the **Objects** tab). It does not affect the communication with LWM2M devices. 