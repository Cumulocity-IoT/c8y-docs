...
When registering a device in Cumulocity that already exists in ThingPark, the agent automatically updates its routing configuration using routing profiles for Wireless connections and route references for Enterprise connections. 
