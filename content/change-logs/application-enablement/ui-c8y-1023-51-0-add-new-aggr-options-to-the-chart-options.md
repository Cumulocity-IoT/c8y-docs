---
date: ""
title: New aggregation options added to the data point graph and data explorer
...
This enhancement is available in the data point graph and the data explorer.