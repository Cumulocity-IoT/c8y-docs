...
version: 1023.75.0
---
The "Event list" widget has been migrated to Angular and enhanced to improve usability and performance, providing a modern, consistent foundation with the current UI framework. Updates include:                                                                                                                                                                                                                                                                 
