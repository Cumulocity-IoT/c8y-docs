...
AI Workbench runs as a standalone microservice and can be deployed in your {{< product-c8y-iot >}} environment alongside your existing applications and services. You can connect to it over MCP from any MCP-capable client or configure it directly in the AI Agent Manager, where you can add it to your agents without additional setup.
