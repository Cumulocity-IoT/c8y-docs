...
version: 1023.0.0
---
Starting with version 1023.0.0, the Web SDK has been upgraded to Angular 20. As Angular is updated half yearly, the y2026 release is skipping the intermediate Angular 19 version. This update brings performance improvements and new features, but also introduces a critical breaking change regarding the standalone flag that requires immediate attention.
