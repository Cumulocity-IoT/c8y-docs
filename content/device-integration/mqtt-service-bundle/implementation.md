...
Streaming Analytics or a custom microservice will receive the exact same set of bytes that was sent by an MQTT device, and is responsible for converting these to {{< product-c8y-iot >}} compatible format.
