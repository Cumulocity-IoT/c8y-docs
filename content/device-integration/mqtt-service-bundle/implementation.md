...
Streaming Analytics or a custom microservice will receive the exact same set of bytes that was sent by an MQTT device, and are responsible for converting these to a {{< product-c8y-iot >}} compatible format.
