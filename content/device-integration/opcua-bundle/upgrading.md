...
3. **Download and run data migration tool**: A data migration tool is provided to facilitate the transition of your existing data to the new format. 
Download the tool from [here](https://resources.cumulocity.com/examples/opc-ua/migration-tool-for-1022-upgrade/) and follow the instructions in the `README.md` file to execute the migration.
...
5. **Update gateway jar file**: Replace the existing gateway jar file with the new version.
