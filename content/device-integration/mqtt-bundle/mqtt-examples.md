...
If you don't have a valid certificate, you can generate one for testing purposes following this tutorial [Device certificates](/device-certificate-authentication/device-certificates/), following the instructions below.
