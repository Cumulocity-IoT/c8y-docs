...
The Sigfox agent also supports the decoding/encoding functionality by plugging in Custom microservice. Refer [LPWAN custom codec](/device-integration/lpwan-custom-codec) for further details.
