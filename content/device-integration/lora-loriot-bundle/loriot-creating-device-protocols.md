...
### Using Custom decoding {#using-custom-decoding}

The Loriot agent also supports the decoding functionality by plugging in the custom microservice. Refer to [LPWAN custom codec](/device-integration/lpwan-custom-codec) for further details.
