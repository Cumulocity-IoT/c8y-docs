...
### Smart rules memory limitation guidelines {#smart-rules-memory-limitation}

When creating smart rules, you must be aware of memory usage limitations to help prevent service instability or memory-related outages. The following guidelines provide approximate memory consumption values and recommended limits.
