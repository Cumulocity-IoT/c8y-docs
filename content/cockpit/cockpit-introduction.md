...
- [{{< product-c8y-iot >}} Developers Codex](https://cumulocity.com/codex/) for details on developing own web applications which can be deployed on top of {{< product-c8y-iot >}}.
{{< /c8y-admon-related >}}
