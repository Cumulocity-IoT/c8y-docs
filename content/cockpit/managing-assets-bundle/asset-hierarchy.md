...
- Refer to the [{{< product-c8y-iot >}} Web developer codex](https://cumulocity.com/codex/) for more information on developing applications in the {{< product-c8y-iot >}} environment. Moreover find various related tutorials in the [{{< c8y-tech-community >}}]({{< c8y-tech-community-link >}}).
{{< /c8y-admon-related >}}
