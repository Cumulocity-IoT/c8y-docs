...
To access it, click **Manage beta features** in the right drawer and toggle the feature on. Then navigate to the dashboard settings and open the **Import/export** tab.
