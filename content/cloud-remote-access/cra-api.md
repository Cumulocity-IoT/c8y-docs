...
1) Development of **device-side components** which enable the access to services like *VNC*, *SSH*, *Telnet* or arbitrary TCP-based protocols (*passthrough*) using the device as a gateway.
