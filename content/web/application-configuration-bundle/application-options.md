...
To see all available options, refer to [Styling with application options](https://cumulocity.com/codex/common-tasks/application-styles/overview#styling-with-application-options) in the {{< product-c8y-iot >}} Codex.
