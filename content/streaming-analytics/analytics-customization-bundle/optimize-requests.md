...
For more details see [Optimizing requests to {{< product-c8y-iot >}} with concurrent connections]({{< link-apama-webhelp >}}/standard-connectivity-plugins/the-cumulocity-iot-transport-connectivity-plug-in/#optimizing-requests-to-cumulocity-iot-with-concurrent-connections) in the Apama documentation.
