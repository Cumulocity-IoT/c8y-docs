...
2.  For the input and output blocks, you can select a different input source or output destination from a dialog box.
    ...
    Using the checkboxes at the top of the dialog, you can filter the entries that are to be shown. By default, all defined devices, groups, smart groups and assets are displayed in the dialog. If you also want to display any other managed objects in the dialog, select the "Other" checkbox.
