...
* **{{< product-c8y-iot >}} > Event Definitions for {{< product-c8y-iot >}}** <br>
Provides event APIs required for sending and receiving data to/from {{< product-c8y-iot >}}.
* **{{< product-c8y-iot >}} > Utilities for {{< product-c8y-iot >}}** <br>
...
* **{{< product-c8y-iot >}} > {{< product-c8y-iot >}} Client** <br>
...
For further information, see [The {{< product-c8y-iot >}} Transport Connectivity Plug-in]({{< link-apama-webhelp >}}/standard-connectivity-plugins/the-cumulocity-iot-transport-connectivity-plug-in/) in the Apama documentation.
...
See also [Apama Docker image availability on Docker Hub]({{< c8y-tech-community-link >}}/t/apama-docker-image-availability-on-docker-hub/5724).
{{< /c8y-admon-info >}}
