...
and [Invoking other parts of the {{< product-c8y-iot >}} REST API]({{< link-apama-webhelp >}}/standard-connectivity-plugins/the-cumulocity-iot-transport-connectivity-plug-in/#invoking-other-parts-of-the-cumulocity-rest-api) in the Apama documentation.
