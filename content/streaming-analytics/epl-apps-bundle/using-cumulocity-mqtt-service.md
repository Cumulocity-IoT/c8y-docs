...
For further documentation on using MQTT Service generally see [MQTT Service](/device-integration/mqtt-service/) and within EPL Apps, see [the Apama documentation]({{<link-apama-webhelp>}}//standard-connectivity-plugins/cumulocity-mqtt-service/).
