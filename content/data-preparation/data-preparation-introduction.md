...
- label: data-preparation-introduction
  ...
  content: "Data Preparation provides an AI-first environment for transforming raw device messages into standard Cumulocity IoT objects such as measurements, events, and alarms. You define rules that listen on MQTT topics, apply transformation logic through smart functions, and forward the results to the platform.
