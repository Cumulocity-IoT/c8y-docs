...
<p align="center" width="100%">
 ...
 Data Preparation receives raw device messages, applies user-defined transformation logic, and forwards the resulting {{< product-c8y-iot >}} objects to the platform for persistence and use by applications (for example, Streaming Analytics).  
