...
The **Overview** page contains the following widgets:

* **Featured Add-on** - A widget showcasing one of the add-ons offered by {{< company-c8y >}} available for your environment. 
...
* **Commit to consume** - A widget providing the details of your CTC contract, specifically the start/end dates and the total commitment value. 
