...
At the top of the page, you find the following two filters:
...
You can toggle the **Show breakdown** to display all components of the Messages metric.
<img src="/images/console/usage/overview/messages-breakdown.png" alt="Messages Breakdown">

The next widget is the **Operational Data Store (ODS)** graph, which displays the total aggregated storage use across all the selected environments and tenants.
