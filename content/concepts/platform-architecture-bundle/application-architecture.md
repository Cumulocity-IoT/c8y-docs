...
**Data lake query** gives applications and business-intelligence tools access to the archived data in the data lake. Because it is stored in open [Apache Iceberg](https://iceberg.apache.org/) tables, it can be queried both from within {{< product-c8y-iot >}} and from external tools such as notebooks, AI/ML platforms, and BI tools — through [Streaming Lake Ingestion](/datahub/streaming-lake-ingestion/) and [DataHub](/datahub/datahub-overview/). This is where large-volume, historical, and cross-system analysis happens.
