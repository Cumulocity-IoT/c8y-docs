...
- [Service management](/device-management-application/managing-device-services/)- to monitor the status and metrics defined for and sent by the model (like accuracy, latency, resource consumption).   
...
- [Remote access](/cloud-remote-access/cra-introduction/) capabilities and a [CLI tool](https://goc8ycli.netlify.app/docs/introduction/) - to directly access devices and interact with the workloads running on top of them.
