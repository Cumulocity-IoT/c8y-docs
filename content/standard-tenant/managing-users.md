...
{{< c8y-admon-info >}}
While entering the password, the strength of the password will be checked. See [To change your password](/get-familiar-with-the-ui/user-settings/#to-change-your-password) for further information on password reset and strength.
{{< /c8y-admon-info >}}
