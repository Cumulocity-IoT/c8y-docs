...
- [Getting started > Technical concepts > Application enablement](/concepts-introduction/#application-enablement) for an overview on the basic concepts of applications in {{< product-c8y-iot >}}.
