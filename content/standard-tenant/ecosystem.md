...
- [{{< product-c8y-iot >}} Developers Codex](https://cumulocity.com/codex/) for information on how to develop web applications on top of {{< product-c8y-iot >}} and how to customize existing applications.
