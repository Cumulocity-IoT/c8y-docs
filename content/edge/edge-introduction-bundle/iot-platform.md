...
|[Managing device services](/device-management-application/managing-device-services/)|How to monitor the data that your devices send about the services they are running. See detailed information about [measurements](/device-management-application/managing-device-services/#measurements), [events](/device-management-application/managing-device-services/#events) and [alarms](/device-management-application/managing-device-services/#alarms) sent for every service.
...
|[Working with reports](/cockpit/working-with-reports/)|Handle [reports](/cockpit/working-with-reports/) based on dashboard layouts, create [reports for exporting data](/cockpit/working-with-reports/#to-create-a-report) in CSV or excel format and [schedule the export](/cockpit/exports/#to-schedule-an-export).
...
|[Managing exports](/cockpit/exports/#managing-exports)|[Export data](/cockpit/exports/#to-export-data) to either CSV or Excel files. [Add](/cockpit/exports/#to-add-an-export) and [schedule](/cockpit/exports/#to-schedule-an-export) an export to a CSV or XLSX file to any point in time.
...
|[Audit logs](/standard-tenant/monitoring/#audit-logs)|How to [view](/standard-tenant/monitoring/#to-view-audit-logs) and [filter](/standard-tenant/monitoring/#to-filter-logs) audit logs that show security-relevant operations that have been processed by a user. See the different [audit log types](/standard-tenant/monitoring/#audit-log-types) for more information.
