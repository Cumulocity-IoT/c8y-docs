...
|**Edge appliance image**|To be downloaded from the [{{< company-sag >}} {{< sag-portal >}}]({{< link-sag-portal >}}), based on the target hypervisor. <br><br> For VMware (ESXi and Workstation Player), download all the 4 files:<br>- Cumulocity Edge - VMWare [Disc 1] (*version*)<br>- Cumulocity Edge - VMWare [Disc 2] (*version*)<br>- Cumulocity Edge - VMWare .mf (*version*)<br>- {Cumulocity Edge - VMWare .ovf (*version*)<br><br> For Hyper-V, download the ZIP file:<br>- Cumulocity Edge - HyperV (*version*)<br><br>The fixes for Edge:<br>- Cumulocity Edge (*version*) Update|
