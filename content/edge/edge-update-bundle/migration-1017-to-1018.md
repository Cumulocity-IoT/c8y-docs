...
{{< c8y-admon-info >}}
Install the Edge 10.18 appliance with the same domain and license as those of the older Edge Appliance VM you are migrating. For detailed steps, refer to [Installing Edge](/edge/edge-installation).
{{< /c8y-admon-info >}}
