...
- [Updating Edge using the GUI](https://{{< domain-c8y >}}/docs/edge/edge-update/#updating-edge-gui)
- [Updating Edge using the REST APIs](https://{{< domain-c8y >}}/docs/edge/edge-update/#updating-edge-rest)
