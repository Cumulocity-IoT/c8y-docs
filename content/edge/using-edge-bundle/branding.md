...
Log into the {{< management-tenant >}} using the management domain and administrator credentials created during the installation. For more information on logging in to the {{< management-tenant >}}, see [To access Edge](/edge/installing-edge-on-k8/#to-access-cumulocity-iot-edge)
