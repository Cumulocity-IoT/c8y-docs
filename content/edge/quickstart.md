...
This section helps you quickly install {{< product-c8y-iot >}} Edge with default configuration. The [installation](/edge/installing/) section covers in greater detail how to install and configure Edge for production deployments.
...
Before proceeding, ensure that you have met the [prerequisites](/edge/installing/#prerequisites) and applied the necessary [operating system configurations required by K3s](https://docs.k3s.io/installation/requirements#operating-systems).
