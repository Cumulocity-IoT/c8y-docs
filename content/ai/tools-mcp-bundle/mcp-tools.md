...
For MCP server implementation details, refer to the Model Context Protocol specification. We also recently published an article on how to build MCP servers with [NestJS in our TechCommunity](https://community.cumulocity.com/t/ai-agent-manager-using-a-mcp-server-to-generate-widgets/14172) and publish them on {{< product-c8y-iot >}}-Platform as a microservice.
