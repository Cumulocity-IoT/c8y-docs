...
"Parameter command line name" of the table in chapter [Package goal](/microservice-sdk/java/#package-goal).
...
declaration for applications to start. Refer to the [Spring Security documentation](https://github.com/spring-projects/spring-security/releases/tag/5.8.0) for more details.
