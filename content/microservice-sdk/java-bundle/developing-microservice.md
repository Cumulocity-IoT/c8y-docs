...
* The `content(matcher)` method of RestAssured has been replaced with `body(matcher)`, see **Broken link**[RequestSpecification#content()](https://javadoc.io/static/io.rest-assured/rest-assured/3.3.0/io/restassured/specification/RequestSpecification.html#content-byte:A-)
