...
(If a single xml tag is specified as parameter in the following list, use embracing xml tags like \<tag>...\</tag> to set those parameters in pom.xml. "..." must be replaced by the respective value of the corresponding data type. Use "Command line parameter name" to set the corresponding parameter on maven command line.)

| Parameter<br>short form<br>for pom.xml entries<br> in \<configuration> section |                                      Data type                                       |                                               Command line<br>parameter name                                                |                                             Default value                                              | Description                                                                                                                                                                                                                                    |
|:------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------:|:-------------------------------------------------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------------------:|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
file *cumulocity.json*. You must be aware of the effect these parameters might have. These parameters are directly
used for the microservice start without further verification. For example, make sure that the heap values meet the
condition: Xms < Xmx.
{{< /c8y-admon-info >}}
...
```
The properties can be used inside the configuration section of the microservice-package-maven-plugin 
