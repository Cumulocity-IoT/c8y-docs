...
When the microservice is ready for a production release, the "-SNAPSHOT" postfix must be removed, and a final version number (for example, "2.1.0") should be used.
