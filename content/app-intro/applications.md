...
- **[Web developer codex](https://cumulocity.com/codex/)** - Comprehensive resources for building custom frontend solutions on top of the {{< product-c8y-iot >}} platform using the {{< product-c8y-iot >}} Web SDK. 
