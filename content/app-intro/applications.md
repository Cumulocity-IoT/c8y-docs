...
- **[Codex](https://cumulocity.com/codex/)** - Comprehensive design system offering UI guidelines, reusable Angular components, and styling utilities to ensure consistent application development.
