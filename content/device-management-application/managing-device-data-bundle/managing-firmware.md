...
4. Select one of the following options to define the patch binary:
   ...
   - **Provided** – Select this option if the device is expected to resolve the binary itself. No file or URL will be defined, and an empty string is stored as value of the `url` attribute.
5. Click **Save**.
