...
A conceptual, documented library of standard JSON structures ([fragments](#fragment)) that define the platform's data model for common device capabilities. It serves as a developer reference for building integrations.   
