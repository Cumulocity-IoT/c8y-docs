...
Web applications are managed via the Application API (`/application/applications`) with type: HOSTED. They are uploaded as ZIP archives containing at least an *index.html* file and optionally a *cumulocity.json* file.
{{< /c8y-details >}}
