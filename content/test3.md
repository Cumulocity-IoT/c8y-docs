---
date: '2026-02-19'
title: Fixed the issue with the creation of child additions
...
* Connect a [Raspberry Pi as demo device using thin.edge.io](https://thin-edge.github.io/thin-edge.io/start/getting-started/). The Raspberry Pi is a relatively simple and cheap yet powerful device. This makes it ideal for testing and trying out as well as some production use cases.
...
Go to [Sensor App](/sensor-app/sensorapp-introduction/) to see which smartphone sensors and Bluetooth devices are currently supported as well as more information on [how to install the app](/sensor-app/installing-the-sensor-app/) available for iOS and Android.
