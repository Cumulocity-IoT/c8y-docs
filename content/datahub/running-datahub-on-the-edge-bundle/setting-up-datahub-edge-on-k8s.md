 ...
 * 100 GB of free disk space plus sufficient free disk space for the data lake contents. For more information about configuring the storage, see [Prerequisites](/{{< c8y-edge-version-major >}}/edge-kubernetes/installing-edge-on-k8/#prerequisites).
