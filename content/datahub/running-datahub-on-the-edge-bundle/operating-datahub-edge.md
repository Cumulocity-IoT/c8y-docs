...
If you need to contact [product support](/additional-resources/contacting-support/), include the diagnostic log archive. See [Accessing logs](https://cumulocity.com/docs/{{< c8y-edge-version-major >}}/edge-kubernetes/installing-edge-on-k8/#accessing-logs).
