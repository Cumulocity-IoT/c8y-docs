...
If you need to contact [product support](/additional-resources/contacting-support/), include the diagnostic log archive. See [Accessing logs](/2025/edge-kubernetes/installing-edge-on-k8/#accessing-logs).
