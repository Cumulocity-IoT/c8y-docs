...
| {{< product-c8y-iot >}} DataHub Edge archive | You have downloaded the archive with all installation artifacts as described under [Installation requirements](/docs/edge/edge-installation/#installation-requirements). |
