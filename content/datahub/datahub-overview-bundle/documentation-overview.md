...
| [Running {{< product-c8y-iot >}} DataHub on {{< product-c8y-iot >}} Edge](https://cumulocity.com/docs/{{< c8y-edge-version-major >}}/datahub/running-datahub-on-the-edge) | Run the Edge edition of {{< product-c8y-iot >}} DataHub |
