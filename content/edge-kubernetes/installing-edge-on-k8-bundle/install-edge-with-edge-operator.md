...
**Important:**
* Edge requires that your Kubernetes cluster has support for **LoadBalancer services** in order for the Cumulocity UI and APIs to be accessible outside of the cluster.
