...
- Extensions - You need either a widget or plugin, see [Micro frontends](https://cumulocity.com/docs/2024/web/microfrontends/) for details. Upload the extension zip to the software repository with the software type _c8yedge_extension_
