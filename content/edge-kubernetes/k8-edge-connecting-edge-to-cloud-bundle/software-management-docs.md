...
- Extensions - You need either a widget or plugin, see [Micro frontends](https://styleguide.cumulocity.com/apps/codex/#/getting-started/microfrontends/overview) in the {{< product-c8y-iot >}} Codex for details. Upload the extension zip to the software repository with the software type _c8yedge_extension_
