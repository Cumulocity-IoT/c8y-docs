...
| <span style="white-space: nowrap;">Source missing</span> | The managed object (device) configured as the source for this linked data point cannot be found or is currently unavailable in the Cumulocity inventory. This could be due to the device being deleted. The link itself is defined, but its target is absent.
